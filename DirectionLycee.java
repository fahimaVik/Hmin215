...
public class DirectionLycee implements Iterable<EmployeLycee> {
	...
	public String toString() {
		String res ="Direction du lycee "
				+"\nproviseur "+this.getProviseur() //+ securité
	...
	public Iterator<EmployeLycee> iterator() {
		...
		//La classe crée est donc agréga
	}
	
	//********* ITERATEUR ******************
	
 //Observer ageMoyen avec l'itÃ©rateur et for	
	...
	//********* DEVOIR MAISON (Ã  rendre par groupe) ******************
	...
	// version 2 : en considÃ©rant l'iterateur (avec for)
